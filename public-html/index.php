...
<html lang="en">
  ...
  <div class="container">
    ...
    <?php if (isset($_SESSION["msgid"]) && $_SESSION["msgid"]!="") {
		...
		<div class="col-6">
			<form name= "formSignUp" action="signup.ctrl.php" method="post" novalidate>
				<div class="form-group">
					...
					<input type="email" class="form-control" id="formSignUpEmail" name="formSignUpEmail" placeholder="Enter your email address" required pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-z-A-Z]{2,}|[.][\w-]{2,}[.][a-z-A-Z]{2,})$"
> 
				</div>
				<div class="form-group">
