...
<html lang="en">
  ...
  <div class="container">
	<div class="row justify-content-md-center">
		<div class="col-12 col-md-auto"><h1>TALKER </h1></div>
	</div>
...
<!-- SYSTEM-WIDE FEEDBACK -->
	...
	<div class="row">
		<div class="col-6">
          ...
          )[0]); }?>" id="formSignUpEmail" name="formSignUpEmail" placeholder="Enter your email address" required pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-z-A-Z]{2,}|[.][\w-]{2,}[.][a-z-A-Z]{2,})$">
          ...
          )[0]); ?>" id="formSignUpPassword" name="formSignUpPassword" placeholder="Enter your password" required pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@*$#]).{8,16}" onkeyup="jsSignUpValidatePassword()">
...
<script>
      ...
      function jsSignUpValidatePassword(){
        if(!jsPasswordRegexPattern.test(jsSignUpPassword.value)) {
          if (!doument.getElementById("formSignUpPasswordInvalidFeedback"))  {
